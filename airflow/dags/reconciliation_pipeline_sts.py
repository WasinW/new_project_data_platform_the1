# airflow/dags/reconciliation_pipeline_sts.py
"""
Reconciliation Pipeline - Following Context Detail Requirements
✅ Uses Dataflow with reconciliation_pipeline_sts.py for processing  
...
def create_reconciliation_dag(domain: str):
    ...
    run_reconciliation_dataflow = DataflowCreatePythonJobOperator(
        ...
        py_file=f'gs://{Variable.get("gcp_project_id")}-pipeline-configs/dataflow/reconciliation_pipeline_sts.py',
